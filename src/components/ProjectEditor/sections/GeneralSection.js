...
function GeneralSection({ formData, errors, onInputChange, onBlur, isEditing = false }) {
  return (
    <>
      {!isEditing && (
        ...
        <div className="form-group">
          ...
          <div className="project-type-display">
            <span className="project-type-badge">
              {formData.projectType === 'roads' ? 'Дороги' : 'Объект'}
            </span>
            <small className="project-type-note">Тип проекта нельзя изменить для существующих проектов</small>
          </div>
        </div>
      )}
