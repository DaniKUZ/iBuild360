  ...
  return (
    <div className="video360-section">
      ...
      <div className="scheme-selector-section">
        <h4>Выбор плана этажа</h4>
        <div className="scheme-selector">
          <label htmlFor="scheme-select">
            <i className="fas fa-layer-group"></i>
            Выберите план этажа из секции "Планы этажей":
          </label>
          <select
            id="scheme-select"
      ...
      <div className="video360-content">
        ...
        <div className="video360-instructions">
          ...
          <ul>
                            <li><strong>Выбор плана этажа:</strong> Сначала выберите план этажа из секции "Планы этажей", к которому будет привязано видео</li>
            ...
            <li><strong>Отправка на сервер:</strong> После выбора плана этажа и загрузки видео нажмите "Отправить на сервер"</li>
