...
// Utils
import { validateForm, isFormValid } from './ProjectEditor/utils/validation';
  ...
  return (
    <div className="project-editor">
      ...
      <div className="editor-actions">
        ...
        <button 
          className={`btn btn-primary ${(activeSection === 'general' && !formIsValid) ? 'disabled' : ''}`}
          onClick={handleNext}
          disabled={activeSection === 'general' && !formIsValid}
        >
